...
function metadata(overrides = {}) {
  return [
    "version: 0.2.1",
    "files:",
    "  - url: Omperator-0.2.1-mac-arm64.zip",
    `    sha512: ${sha512}`,
    "    size: 1234",
    "  - url: Omperator-0.2.1-mac-arm64.dmg",
    `    sha512: ${dmgSha512}`,
    "    size: 2345",
    "path: Omperator-0.2.1-mac-arm64.zip",
    `sha512: ${sha512}`,
...
test("validates the exact signed macOS update zip contract", () => {
  assert.deepEqual(
    validateMacUpdateMetadata(metadata(), {
      version: "0.2.1",
      zipName: "Omperator-0.2.1-mac-arm64.zip",
      zipSize: 1234,
      zipSha512: sha512,
      dmgName: "Omperator-0.2.1-mac-arm64.dmg",
      dmgSize: 2345,
      dmgSha512,
    }),
    {
