...
[**Download v0.1.34**](https://github.com/wolfiesch/omperator/releases/tag/v0.1.34) · [**Docs**](https://t4code.net/docs) · [**Get the source**](#build-from-source)
...
2. Download [`T4-Code-0.1.34-android.apk`](https://github.com/wolfiesch/omperator/releases/download/v0.1.34/T4-Code-0.1.34-android.apk).
...
```sh
wget https://github.com/wolfiesch/omperator/releases/download/v0.1.34/T4-Code-0.1.34-linux-amd64.deb
sudo apt install ./T4-Code-0.1.34-linux-amd64.deb
```
...
```sh
wget https://github.com/wolfiesch/omperator/releases/download/v0.1.34/T4-Code-0.1.34-linux-x86_64.AppImage
chmod +x T4-Code-0.1.34-linux-x86_64.AppImage
./T4-Code-0.1.34-linux-x86_64.AppImage
```

### macOS (Apple Silicon)

1. Download [`T4-Code-0.1.34-mac-arm64.dmg`](https://github.com/wolfiesch/omperator/releases/download/v0.1.34/T4-Code-0.1.34-mac-arm64.dmg) (or [`T4-Code-0.1.34-mac-arm64.zip`](https://github.com/wolfiesch/omperator/releases/download/v0.1.34/T4-Code-0.1.34-mac-arm64.zip)).
