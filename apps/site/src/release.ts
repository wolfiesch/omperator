...
export const RELEASE_ASSETS: readonly ReleaseAsset[] = [
  asset("android", "apk", "universal", "Omperator-0.2.0-android.apk", "Android APK"),
  asset("linux", "deb", "x86_64", "Omperator-0.2.0-linux-amd64.deb", "Linux .deb"),
  asset("linux", "appimage", "x86_64", "Omperator-0.2.0-linux-x86_64.AppImage", "Linux AppImage"),
  asset("mac", "dmg", "arm64", "Omperator-0.2.0-mac-arm64.dmg", "macOS .dmg"),
  asset("mac", "zip", "arm64", "Omperator-0.2.0-mac-arm64.zip", "macOS .zip"),
];
