...
OMP_INTEGRATION_REPOSITORY=${T4_LOCAL_OMP_REPOSITORY:-https://github.com/wolfiesch/oh-my-pi.git}
OMP_UPSTREAM_REPOSITORY=${T4_LOCAL_OMP_UPSTREAM_REPOSITORY:-https://github.com/can1357/oh-my-pi.git}
OMP_INTEGRATION_SLUG=${T4_LOCAL_OMP_REPOSITORY_SLUG:-wolfiesch/oh-my-pi}
OMP_UPSTREAM_SLUG=${T4_LOCAL_OMP_UPSTREAM_REPOSITORY_SLUG:-can1357/oh-my-pi}
OMP_PRODUCT_BRANCH=t4code/main
T4_REPOSITORY=${T4_LOCAL_T4_REPOSITORY:-wolfiesch/omperator}
T4_CLONE_URL=${T4_LOCAL_T4_CLONE_URL:-https://github.com/wolfiesch/omperator.git}
